...
// set this as desired
var jmolDirectory = " http://chemapps.stolaf.edu/jmol/docs/examples-11"
var jmolJar = "JmolAppletSigned0.jar"
...
function __jmolFixJmolApplet(tag) {
	...
	if (A.archive == "JmolApplet.jar") A.archive = jmolJar
...
function __fixChime() {
	jmolInitialize(jmolDirectory, jmolJar)
	jmolSetDocument(0)
